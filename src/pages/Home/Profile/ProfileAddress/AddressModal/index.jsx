...
const AddressModal = ({ show, handleClose, method, additionalAddress }) => {
  ...
  return (
    <Modal
      show={show}
      className="address-paddingContainer"
      onHide={handleClose}
      centered
      size="lg"
      animation="true"
        ...
        <Modal.Body>
          <div className="modal-bodyContainer">
            <div className="modal-iconContainer">
              <button
                onClick={() =>
                  setAddressData({ ...addressData, place: "Home" })
                }
              ...
              <button
                onClick={() =>
                  setAddressData({ ...addressData, place: "Work" })
                }
                className="modal-innerIconContainer"
              >
            ...
            <div className="modal-buttonsContainer">
              <button className="modal-buttonClose" onClick={handleClose}>
                Close
              </button>
              <button
