...
const HealthCareTxt = () => {
  return (
    <>
      <div className="par-txt-care">
        <p className="par-txt-care1">Shop Safely And Worry-Free On Prana 24?</p>
        <p className="pharm-text">
      ...
      <div className="par-txt-care">
        <p className="par-txt-care1">Why choose PharmEasy?</p>
        <ul>
          <li>
            <p className="pharm-text">8400+ Brands</p>
          </li>
          <li>
            <p className="pharm-text">35K products in our stock</p>
          </li>
          <li>
            <p className="pharm-text">Delivery to 22000+ pin codes</p>
          </li>
          <li>
            <p className="pharm-text">Over 2M customers served</p>
          </li>
        </ul>
      </div>
      <div className="par-txt-care">
        <p className="par-txt-care1">Our most popular categories:</p>
        <p className="pharm-text">
          We have a range of categories and products, some which are:
        </p>
      </div>
      <div className="par-txt-care">
        <p className="par-txt-care1">We ensure</p>
        <ul>
          <li>
            <p className="pharm-text">
          ...
          <li>
            <p className="pharm-text">No-contact door-step delivery</p>
          </li>
          <li>
            <p className="pharm-text">Sanitized packaging</p>
          </li>
        </ul>
      </div>
      <div className="par-txt-care">
        <p className="par-txt-care1">Youe safety is our priority</p>
        <p className="pharm-text">
