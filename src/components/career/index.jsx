      ...
      <div className="career-body">
        <div className="career-head">
          <p>
            ...
            biggest medicines/ medical devices wholesaler and pharmacy financing
            partner starting
            <br /> in Nigeria. We are backed by some of the most well respected
            investors in Africa & the U.S.
          </p>
        </div>
      </div>
