    ...
    <>
      <div>
        <div className="innerHealth-Blog">
          ...
          <p className="innerHealthBlog-par1">
            A round-up of all the health news you can use, stay updated on new
            treatment, medical research, and wellness
          </p>
        </div>
              ...
              <>
                <div className="card-card-innercared">
                  <Card className="card-img-health-care" id="card-health">
                    <img
                      className="vitamin-img-healthcare"
                      src={item.Image}
                      alt=""
                    />
                    <p className="world-par">{item.Title}</p>
                    <p className="world-par">{item.Text}</p>
                    <p className="world-par2" id="ayur-par-slide">
                      {item.Par}
                    </p>
                  </Card>
                </div>
